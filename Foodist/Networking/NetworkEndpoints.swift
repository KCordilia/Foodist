...
//chinese,japanese,korean,vietnamese,thai,indian,british,
enum CuisineType: String {
    case irish,french,italian,mexican, spanish,middleEastern="middle+eastern",jewish,american,greek,easterneuropean,caribbean,latinAmerican="latin+american"
}
enum Intolerances {
